...
CREATE TABLE `user` (
  ...
  `user_icon` varchar(255) DEFAULT 'http://178.128.236.114:8080/empty-video-files/images/user/defaultUserIcon.jpg',
  `user_banner` varchar(255) DEFAULT 'http://178.128.236.114:8080/empty-video-files/images/user/defaultUserBanner.jpg',
